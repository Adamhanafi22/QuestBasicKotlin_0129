...
// Data class
// Data class adalaj class yang digunakan untuk menyimpan data
// Data class menyediakan fungsi untuk meng-override fungsi equales(), hashCode(), dan toString().
...
fun main (){
    ...
    val data4 = data.copy(email = "sahar2gmail.com")
    println(data4)
}
